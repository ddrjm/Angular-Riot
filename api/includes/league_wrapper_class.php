...
class LOL {
     ...
     * @param  string $api_key     String of your api key
     * @param  string $region      String of the selected region
     * @param  string $locale_code String of the locale code
     */
    public function setconfig($region, $locale_code = 'en_US') {
